...
@section('content')
    ...
    <div class="container-fluid py-4">
        ...
        <div class="mb-4 mt-5">
            <div class="">
                <div class="formedit card">
                    <div class="card-body">
                        <form class="m-4" action="{{ route('news.store') }}" method="post"
                            enctype="multipart/form-data">
                            <div class="form-group">
                                <label for="topic">Topic</label>
                                <textarea type="text"  name="topic" id="" class="border form-control" placeholder=""
                                    aria-describedby="helpId"></textarea>
                                @error('topic')
                                    <span class="errors">{{ $errors->first('topic') }}</span>
                                @enderror
                            </div>

                            <div class="form-group">
                                <label for="topic">Text</label>
                                <textarea type="text" name="text" name="editordata" id="" class="border form-control" placeholder=""
                                    aria-describedby="help"></textarea>
                                @error('section_id')
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-sm-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control border" type="file" name="pics" id="">
                                        @error('pics')
                                            <span class="errors">{{ $errors->first('pics') }}</span>
                                        @enderror
                                    </div>
                                </div>
                                <div class="col-lg-6 col-sm-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control border" name="section_id" id="">
                                            <option value="">none</option>
                                        ...
                                        @error('section_id')
                                            <span class="errors">{{ $errors->first('section_id') }}</span>
                                        @enderror
                                    </div>
                                </div>
                            </div>
