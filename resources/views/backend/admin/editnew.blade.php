        ...
        <div class="mb-4 mt-5">
            <div class="">
                <div class="formedit card">
                    <div class="card-body">
                        <form class="m-4" action="{{ route('news.update', $news->id) }}" method="post"
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" name="topic" id="" class="border form-control" placeholder=""
                                            aria-describedby="helpId">{{ $news->topic }}</textarea>
                                ...
                                <div class="col-lg-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" name="text" id="" class="border form-control" placeholder=""
                                            aria-describedby="help">{{ $news->text }}</textarea>
                                        <small id="helpId" class="text-sm text-muted">j</small>
                                    </div>
                                    @php
