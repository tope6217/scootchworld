...
<head>
    ...
    {{-- <link rel="stylesheet" href="{{ asset('plugin/fontawesome/js/all.min.js') }}"> --}}
    {{-- <script src="{{ asset('plugin/fontawesome/js/fontawesome.min.js') }}"></script> --}}
    <!-- Font Awesome Icons -->
    ...
    <!-- CSS Files -->
    <link rel="stylesheet" href="{{ asset('plugin/bootstrap/css/bootstrap.css') }}">
    <link id="pagestyle" href="{{ asset('backend/assets/css/material-dashboard.min.css?v=3.0.0') }}"
        rel="stylesheet" />
...
<body class="g-sidenav-show  bg-gray-200">
    <aside
        class="sidenav navbar navbar-vertical h-100 navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark"
        id="sidenav-main">
        <div class="sidenav-header w-100">
            ...
            <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/material-dashboard/pages/dashboard "
                target="_blank">
                <img src="{{ asset('backend/assets/img/logo-ct.png') }}" class="navbar-brand-img h-100"
                    alt="main_logo">
